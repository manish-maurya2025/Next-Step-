    ...
    return (
        <div className="flex sm-mx:flex-col-reverse  items-center px-16 bs-mx:px-10 md-mx:px-5">
            <div data-aos="zoom-out-right" className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400">Connect with <span >top</span> <span>internship</span> on NextStep</div>
                <div className="text-lg md-mx:text-base sm-mx:text-sm text-mine-shaft-200">NextStep is an online platform connecting clients with internship for web development, writing, design, and marketing services. Hire the best talent with ease.</div>
                <div className="flex gap-3 mt-5 items-center">
                    <TextInput value={jobTitle} onChange={(e)=>setJobTitle(e.currentTarget.value)} className="bg-mine-shaft-900 rounded-lg p-1 px-2 text-mine-shaft-100 [&_input]:!text-mine-shaft-100" variant="unstyled" label="Service" placeholder="Web Development" />
                    <TextInput value={type} onChange={(e)=>setType(e.currentTarget.value)} className="bg-mine-shaft-900 rounded-lg p-1 px-2 text-mine-shaft-100 [&_input]:!text-mine-shaft-100" variant="unstyled" label="Category" placeholder="Full-time / Contract" />
            ...
            <div data-aos="zoom-out-left"  className="w-[55%] sm-mx:w-full flex items-center justify-center">
                <div className="w-[30rem] relative">
                    ...
                    <div className=" absolute -right-10 bs-mx:right-0 w-fit xs-mx:top-[10%] top-[50%] border-bright-sun-400 border rounded-lg p-2 xs-mx:-left-5      backdrop-blur-md">
                        <div className="text-center mb-1 text-sm text-mine-shaft-100">10K+ successful projects</div>
                        <Avatar.Group>
